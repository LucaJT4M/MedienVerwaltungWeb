...
- Create Angular project with ng: `ng new medienverwaltungweb.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`medienverwaltungweb.client.esproj`).
